...
async function getBooks() {
  const response = await fetch(
    `https://www.googleapis.com/books/v1/volumes?q="subject:${category}"&key=AIzaSyCcCxmGurXOwMSm9DKkQJIRSZCIfNx1wwE&printType=books&startIndex=0&maxResults=${itemsPerPage}&langRestrict=en`
  );
